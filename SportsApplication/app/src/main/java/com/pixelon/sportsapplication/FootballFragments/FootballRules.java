...
public class FootballRules extends Fragment {
    RecyclerView view;
    List<RuleItem> itemList;
    RuleAdapter adapter;
    String newsUrl = "http://mobileappsports.azurewebsites.net/api/file?category=football";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
     ...
     View v = inflater.inflate(R.layout.fragment_football_rules, container, false);
