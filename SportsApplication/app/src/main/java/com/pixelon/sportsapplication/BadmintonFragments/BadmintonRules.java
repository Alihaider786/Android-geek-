...
public class BadmintonRules extends Fragment {

    RecyclerView view;
    List<RuleItem> itemList;
    RuleAdapter adapter;
    String newsUrl = "http://mobileappsports.azurewebsites.net/api/file?category=badminton";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v= inflater.inflate(R.layout.fragment_badminton_rules, container, false);
