...
public class SwimmingRules extends Fragment {

    RecyclerView view;
    List<RuleItem> itemList;
    RuleAdapter adapter;
    String newsUrl = "http://mobileappsports.azurewebsites.net/api/file?category=swimming";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v= inflater.inflate(R.layout.fragment_swimming_rules, container, false);
