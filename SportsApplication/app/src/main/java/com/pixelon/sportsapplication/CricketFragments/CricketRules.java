...
public class CricketRules extends Fragment {
    ...
    RuleAdapter adapter;
    String newsUrl = "http://mobileappsports.azurewebsites.net/api/file?category=cricket";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v= inflater.inflate(R.layout.fragment_cricket_rules, container, false);
