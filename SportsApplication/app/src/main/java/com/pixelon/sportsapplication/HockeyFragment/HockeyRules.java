...
public class HockeyRules extends Fragment {

    RecyclerView view;
    List<RuleItem> itemList;
    RuleAdapter adapter;
    String newsUrl = "http://mobileappsports.azurewebsites.net/api/file?category=hockey";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v= inflater.inflate(R.layout.fragment_hockey_rules, container, false);
