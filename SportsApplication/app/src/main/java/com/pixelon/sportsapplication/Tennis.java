...
import com.pixelon.sportsapplication.TennisFragments.TennisHome;
import com.pixelon.sportsapplication.TennisFragments.TennisNews;
import com.pixelon.sportsapplication.TennisFragments.TennisRules;
...
public class Tennis extends AppCompatActivity {
    ...
    public class SectionsPagerAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int position) {
            ...
            {
                case 0:
                    TennisHome home = new TennisHome();
                    return home;
                case 1:
                    TennisNews news = new TennisNews();
                    return news;
                case 2:
                    TennisRules rules = new TennisRules();
                    return rules;
