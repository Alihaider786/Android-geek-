...
public class TennisNews extends Fragment {
    RecyclerView view;
  ...
  //  boolean topNews = false;
   // String TOP_NEWS = "Top";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_tennis_news, container, false);
                    ...
                    try {
                       ...
                       // JSONArray array = object.getJSONArray("articles");
                        for (int i = 0; i < array.length(); i++) {
                            ...
                            NewsItem myNews = new NewsItem(imageUrl, author, tittle, desc, LATEST_NEWS, detailUrl);
                            itemList.add(myNews);
                            adapter.notifyDataSetChanged();
