...
public class BadmintonNews extends Fragment {
    RecyclerView view;
  ...
  //  String topNewsUrl = "https://newsapi.org/v1/articles?source=espn-cric-info&sortBy=top&apiKey=ed034ed20ac2437da1a2db4ed231b974";
    String newsUrl = "http://mobileappsports.azurewebsites.net/api/news?category=badminton";
...
String TOP_NEWS = "Top";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_badminton_news, container, false);
