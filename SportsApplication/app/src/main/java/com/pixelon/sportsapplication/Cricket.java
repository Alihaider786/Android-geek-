...
public class Cricket extends AppCompatActivity {
     ...
     */
    private CricketPagerAdapter mSectionsPagerAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mSectionsPagerAdapter = new CricketPagerAdapter(getSupportFragmentManager());
     ...
     */
    public class CricketPagerAdapter extends FragmentPagerAdapter {

        public CricketPagerAdapter(FragmentManager fm) {
            super(fm);
        }
        ...
        public Fragment getItem(int position) {
            ...
            {
                case 0:
                    CricketHome home = new CricketHome();
                    return home;
                case 1:
