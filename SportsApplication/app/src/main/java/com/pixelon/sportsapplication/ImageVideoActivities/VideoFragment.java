...
import com.pixelon.sportsapplication.Adapters.VideoAdapter;
...
public class VideoFragment extends Fragment {
    ...
    ProgressBar bar;
    String url="http://mobileappsports.azurewebsites.net/api/VideosData?category=";
    String category;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        adapter = new VideoAdapter(getContext(), itemList);
              ...
              public void onResponse(String response) {
                  ...
                  try {
                      ...
                      for(int i=0; i<array.length(); i++)
                      {
                          ...
                          String urlToImage = object.getString("urlToVideo");
